            ...
            children: [
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        /*Text(
                          '${appStore.currencySymbol}${bookingDetail.amount.validate().toStringAsFixed(DECIMAL_POINT)} * ${bookingDetail.quantity}  = ${appStore.currencySymbol}${(bookingDetail.amount.validate() * bookingDetail.quantity.validate()).toStringAsFixed(DECIMAL_POINT)}',
              ...
              Row(
                children: [
                  ...
                  if (bookingDetail.isHourlyService) Text('(${appStore.currencySymbol}${bookingDetail.totalAmount}/hr)  ', style: secondaryTextStyle()),
