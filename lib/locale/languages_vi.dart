...
class LanguageVi extends BaseLanguage {
  ...
  @override
  String get lblLoginSubTitle => "Chào mừng trở lại, bạn đã bị bỏ lỡ trong một thời gian dài";
  ...
  @override
  String get confirmationRequestTxt => "Bạn có chắc chắn muốn thực hiện hành động này không?";
  ...
  @override
  String get lblAcceptTermsCondition => "Vui lòng chấp nhận các điều khoản và điều kiện";
